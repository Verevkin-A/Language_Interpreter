...
final class CreateHTML
{
    ...
    private function create_body(array $test_results) {
        ...
        // header
        $heading = $this->dom->createElement("h1", "Test results ($passed)");
